...
async def cmd_start(message: Message):
    ...
    pin = await message.answer_photo(
        photo='AgACAgIAAxkBAALI_mgvRMsvw2EJz5jXDg-gvRId3OI5AAJD8DEbn-V4SddS3C1EB2NZAQADAgADcwADNgQ',
        caption='‼️Отправляйте сюда свое тз в строго следующем формате: \n\n' \
        '<code>Желаемый Дизайнер (или -): \n'
        'Количество крео: \n'
        ...
        'Подробное описание задачи: </code>\n\n\n'
        '🔺Для качественного видео <b>с использованием ИИ</b>(синхрон губ) важно чтобы у селебы были хорошего качества исходники: ‼️<b>чем дальше селеба от кадра,тем лучше результат,но если селеба близко или очень сильно мотает головой, то синхронизация будет хуже‼️</b> \n\n\n'
        'Языки,которые доступны для клонирования голоса селебы \n (Английский,Африкаанс,Албанский,Амхарский,Арабский,Бенгальский,Болгарский,Каталонский,Хорватский,Чешский,Датский,Голландский,Французский,Галисийский,Немецкий,Греческий,Хинди,Венгерский,Индонезийский,Итальянский,Японский,Корейский,Малайский,Мандарин,Польский,Португальский,Русский,Сербский,Испанский,Шведский,Филиппинский(Тагальский),Тайский,Турецкий,Украинский,Урду,Коса,Китайский,Румынский,Финский,Словацкий,Вьетнамский,Норвежский)')
